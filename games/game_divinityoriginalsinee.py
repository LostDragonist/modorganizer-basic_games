...
class DivinityOriginalSinEnhancedEditionGame(BasicGame):
    ...
    GameDocumentsDirectory = "%USERPROFILE%/Documents/Larian Studios/Divinity Original Sin Enhanced Edition/PlayerProfiles"
    GameSavesDirectory = "%USERPROFILE%/Documents/Larian Studios/Divinity Original Sin Enhanced Edition/PlayerProfiles"
